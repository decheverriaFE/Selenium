...
namespace SeleniumProject.handler
{
    ...
    public class ReportHandler//Reports handler, to be callable
    {
        ...
        public static void ExtentStart()
        {
            ...
            var htmlReporter = new ExtentHtmlReporter(@"C:\Users\decheverria\source\repos\Selenium2\SeleniumProject\ExtentReport\"); // needs html endpoint, storing on extentreport folder
